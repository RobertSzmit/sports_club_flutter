...
/// @nodoc
mixin _$ChatState {
  List<ChatItem> get messages => throw _privateConstructorUsedError;
...
abstract class $ChatStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ChatItem> messages, bool isLoading, String errorMessage});
}
...
class _$ChatStateImpl implements _ChatState {
  const _$ChatStateImpl(
      {final List<ChatItem> messages = const [],
