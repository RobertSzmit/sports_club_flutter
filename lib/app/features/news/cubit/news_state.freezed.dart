...
abstract class $NewsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<NewsItem> newsItems, bool isLoading, String errorMessage});
}
...
class _$NewsStateImpl implements _NewsState {
  ...
  @override
  String toString() {
    return 'NewsState(newsItems: $newsItems, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_newsItems), isLoading, errorMessage);
